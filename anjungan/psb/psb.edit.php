...
<?      ShowYearCombo('psb_thnlahir', 'psb_changeTahunLahirSiswa()', 1990, date('Y') + 1, $thn); ?>&nbsp;
...
<?      ShowYearCombo('psb_thnlahirayah', 'psb_changeTahunLahirAyah()', 1970, date('Y') + 1, $thn); ?>&nbsp;
...
<?      ShowYearCombo('psb_thnlahiribu', 'psb_changeTahunLahirIbu()', 1970, date('Y') + 1, $thn); ?>&nbsp;
