...
<? 		$sql = "SELECT MIN(nilaiangka) as nmin, MAX(nilaiangka) AS nmax
        ...
        $rentang = array(9*$dasar, 8*$dasar, 7*$dasar,
						 ...
						 3*$dasar, 2*$dasar, 1*$dasar);
		
        $filter = array($rentang[0], $rentang[1].'_'.$rentang[0], $rentang[2].'_'.$rentang[1],
						$rentang[3].'_'.$rentang[2], $rentang[4].'_'.$rentang[3], $rentang[5].'_'.$rentang[4],
						$rentang[6].'_'.$rentang[5], $rentang[7].'_'.$rentang[6], $rentang[8]);
