  		...
  		<tr>
    		...
    		<td width="7%">
                ...
                <select name="tingkat" id="tingkatInfo" onChange="change_tingkat()" style="width:55px;"
                        onKeyPress="return focusNext('kelas',event)" onFocus="panggil('tingkatInfo')">
            ...
            <td>
                ...
                <select name="kelas" id="kelasInfo" style="width:200px;" onKeyPress="return focusNext('idangkatan',event)"
                        onFocus="panggil('kelasInfo')" onChange="change_kelas()">
        ...
        <tr>
            ...
            <td bgcolor="#E9AFCF">
                <input name="tgllahiribu" type="text" size="15" maxlength="100" id="tgllahiribu"
                       ...
                       value="<?=$row_siswa['tgllahirayah']?>" class="ukuran" onKeyPress="return focusNext('Infopendidikanayah', event)" onblur="unfokus('tgllahiribu')"/>
            </td>
        </tr>
        <tr>
            <td>Pendidikan</td>
